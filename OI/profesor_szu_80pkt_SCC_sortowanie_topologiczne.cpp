...
int main()
{
    // 80pkt, w 2 testach nie przechodzi pamieciowo, w limicie 32MB ciezko sie zmiescic. Probowalem krawedzie trzymac w wektorze par(a->b),
    // i sortowac krawedzie i dla kazdej wartosci trzymac idx jej zaczecia, ale to tez nie przechodzi.
    ...
    for (int i = 0; i < ile_spojnych; ++i)
    {
        ...
        if (czy_epic_SCC[v] == true and dp[v] > 0)
            dp[v] = INF;
