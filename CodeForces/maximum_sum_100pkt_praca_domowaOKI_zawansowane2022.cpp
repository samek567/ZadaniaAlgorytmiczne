...
int main()
{
    // O(N * legal^2), gdzie legal to liczba legalnych masek bitowych,
    // czyli takich, ze w danym wierszu nie stoja obok siebie zapalone bity, bo takich nie moze wziac.
